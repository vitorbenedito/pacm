		...
		if (msgType == Message.Type.POSTED_TEXT) {
		   ...
		   Conversation conversation =
            ...
            if (!msgAuthor.equals(mySession.myAccountName)) {
            	...
            	// Checking that we are indeed running the "chat" tutorial insulates the other tutorials, but not itself.   
//            	if (mySession.myTutorialTag.equals(Tutorial_3.MY_TUTORIAL_3_CLASS_TAG)) {
